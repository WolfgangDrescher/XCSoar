...
/**
 * Flat "card" button face (light mode): white cards with a light
 * outline that is almost neutral; a warm border on a warm page reads
 * as dirt, a neutral one as a line.
 */
