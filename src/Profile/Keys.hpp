...
constexpr std::string_view WaypointArrivalInfo = "WaypointArrivalInfo";
constexpr std::string_view WaypointArrivalCalculation = "WaypointArrivalCalculation";
constexpr std::string_view WaypointArrivalInfoPosition = "WaypointArrivalInfoPosition";
constexpr std::string_view WaypointArrivalInfoVisibility = "WaypointArrivalInfoVisibility";
constexpr std::string_view WaypointTextStyle = "WaypointTextStyle";
constexpr std::string_view WaypointHighlightStyle = "WaypointHighlightStyle";
