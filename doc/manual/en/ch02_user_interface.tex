...
While you draw, XCSoar shows the path as a red line with a thin
white edge.  The line turns grey while the figure drawn so far is not
a known gesture.  Once it is, a label at the top of the map names
