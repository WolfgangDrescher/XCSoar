...
switching to a different InfoBox geometry.  An invisible InfoBox can no longer
be tapped, so use the InfoBox configuration page to assign a different InfoBox
to that slot again.}
